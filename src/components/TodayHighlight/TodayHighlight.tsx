...
const HighlightCard = ({ title, imgSrc, imgAlt, children }: HighlightCardProps) => (
  <div className="bg-gradient-to-br from-[#031131] to-[#01050c] rounded-3xl p-6  border-[#1E2A47] flex flex-col justify-between items-center h-48 overflow-hidden">
...
export const TodayHighlight = ({data }: TodayHighlightProps) => {
  return (
    <div className="space-y-5 h-full flex flex-col">
      <div className="bg-gradient-to-br from-[#1a2642] to-[#0f1829] h-full rounded-3xl p-4 border flex flex-col justify-between">
